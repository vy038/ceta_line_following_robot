...
Created: 2024-01-10
Modified: 2024-04-22
Purpose: To create the fastest line following robot with 6 QTI sensors, turning when they detect black
*/
...
void TURN(int dir) { //minor turn function
    if (dir == 1) { //if int is 1, make minor right turn
      ...
      analogWrite(LMotor_pin1, minorSpeed);  
      analogWrite(LMotor_pin2, 0); 
      ...
      analogWrite(RMotor_pin1, minorSpeed);
      analogWrite(RMotor_pin2, 0);
    }
